...
class ReviewResult(BaseModel):
    """Result of the reviewer agent's analysis."""
    passed: bool = Field(description="Whether the generated code passed review")
    issues: list[str] = Field(default_factory=list, description="List of issues found during review")
